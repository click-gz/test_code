...
parser.add_argument("--model_dir", type=str, help="models folder",
                    dest="model_dir", default='/data1/gz/checkpoint/lungct/vxm')
parser.add_argument("--model_dir_cube", type=str, help="models folder",
                    dest="model_dir_cube", default='/data1/gz/checkpoint/lungct/vxm_cube')
