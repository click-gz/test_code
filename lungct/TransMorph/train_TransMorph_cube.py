...
def main():
    ...
    if not os.path.exists('/data1/gz/checkpoint/lungct/transmorph_cube/'):
        os.makedirs('/data1/gz/checkpoint/lungct/transmorph_cube/')
    ...
    while idx<6000:
        ...
        with torch.no_grad():
            ...
            if np.mean(val_loss) < best_dsc:
                ...
                }, save_dir='/data1/gz/checkpoint/lungct/transmorph_cube/', filename='dsc{:.3f}.pth.tar'.format(loss_all.avg))
