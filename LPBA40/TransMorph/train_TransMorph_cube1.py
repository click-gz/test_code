...
def main():
    ...
    if not os.path.exists('/data1/gz/checkpoint/lpba40/transmorph_cube1/'+save_dir):
        os.makedirs('/data1/gz/checkpoint/lpba40/transmorph_cube1/'+save_dir)

    lr = 0.0001 # learning rate
    epoch_start = 0
    max_epoch = 27 #max traning epoch
    ...
    for epoch in range(epoch_start, max_epoch):
        ...
        if np.mean(val_loss) < best_dsc:
            ...
            }, save_dir='/data1/gz/checkpoint/lpba40/transmorph_cube1/' + save_dir, filename='{}.pth.tar'.format(np.mean(val_loss)))
