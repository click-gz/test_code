...
class CubeAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # sitk.WriteImage(sitk.GetImageFromArray(f_cpu[0,0, ...]), "./f1.nii")
        # sitk.WriteImage(sitk.GetImageFromArray(f_cpu[0, 1, ...]), "./f2.nii")
        # sitk.WriteImage(sitk.GetImageFromArray(attn_cpu[0, 0, ...]), "./attn1.nii")
        # sitk.WriteImage(sitk.GetImageFromArray(attn_cpu[0, 1, ...]), "./attn2.nii")
        # exit()
        f = f * x

        x = self.proj_drop(self.act(attn+f)) + x
