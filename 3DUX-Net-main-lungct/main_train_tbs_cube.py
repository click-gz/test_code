...
from networks.TransBTS_cube.TransBTS_downsample8x_skipconnection import TransBTS
...
parser.add_argument('--output', type=str, default='./tbsout_cube', required=False, help='Output folder for both tensorboard and the best model')
