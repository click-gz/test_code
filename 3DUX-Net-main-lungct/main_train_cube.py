...
parser.add_argument('--output', type=str, default='./out_cube_seg', required=False, help='Output folder for both tensorboard and the best model')

# parser.add_argument('--root', type=str, default='/data1/gz/data/seg/', required=False, help='Root folder of all your images and labels')
# parser.add_argument('--output', type=str, default='/data1/gz/data/out', required=False, help='Output folder for both tensorboard and the best model')
...
parser.add_argument('--max_iter', type=int, default=24000, help='Maximum iteration steps for training')
parser.add_argument('--eval_step', type=int, default=174, help='Per steps to perform validation')
    ...
    for step, batch in enumerate(epoch_iterator):
        ...
        if (
            ...
            if dice_val > dice_val_best:
                ...
                torch.save("", os.path.join(root_dir, str(global_step)+"best_metric_model.pth"))
                print(
...
epoch_loss_values = []
metric_values = []
# model.load_state_dict(torch.load("./out1/best_metric_model.pth"))
