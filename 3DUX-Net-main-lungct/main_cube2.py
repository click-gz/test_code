...
parser.add_argument('--root', type=str, default='/home/gz/data/FLARE2021', required=False, help='Root folder of all your images and labels')
parser.add_argument('--output', type=str, default='./out2', required=False, help='Output folder for both tensorboard and the best model')
...
parser.add_argument('--max_iter', type=int, default=50000, help='Maximum iteration steps for training')
