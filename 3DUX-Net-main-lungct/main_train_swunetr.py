...
from networks.SwinUNETR.swunetr import SwinUNETR
...
parser.add_argument('--output', type=str, default='./swunetr_seg', required=False, help='Output folder for both tensorboard and the best model')
...
if args.network == '3DUXNET':
    ...
    model = nnFormer(input_channels=1, num_classes=2).to(device)
...
#
# flops, params = get_model_complexity_info(model, (1, 96, 96, 96), as_strings=True, print_per_layer_stat=True)
