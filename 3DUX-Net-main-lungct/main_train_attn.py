...
from networks.UXNet_3D.network_backbone_attn import UXNET
...
parser.add_argument('--output', type=str, default='./attn', required=False, help='Output folder for both tensorboard and the best model')
