...
from networks.TransBTS_cube1.TransBTS_downsample8x_skipconnection import TransBTS
...
parser.add_argument('--output', type=str, default='./tbsout_cube_seg', required=False, help='Output folder for both tensorboard and the best model')
...
parser.add_argument('--network', type=str, default='TransBTS', help='Network models: {TransBTS, nnFormer, UNETR, SwinUNETR, 3DUXNET}')
...
parser.add_argument('--max_iter', type=int, default=30000, help='Maximum iteration steps for training')
            ...
            if dice_val > dice_val_best:
                ...
                print(
                    "Model Was Saved ! {} Current Best Avg. Dice: {} Current Avg. Dice: {}".format(
                        os.path.join(root_dir, "best_metric_model.pth"), dice_val_best, dice_val
                    )
                )
