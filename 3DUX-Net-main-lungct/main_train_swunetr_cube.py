...
parser.add_argument('--output', type=str, default='./swunetr_cube_seg', required=False, help='Output folder for both tensorboard and the best model')
...
parser.add_argument('--max_iter', type=int, default=25000, help='Maximum iteration steps for training')
...
# model.load_state_dict(torch.load("./swunetr_cube_seg/best_metric_model.pth"))
global_step = 0
dice_val_best = 0.0
global_step_best = 0
epoch_loss_values = []
