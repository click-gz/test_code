...
from networks.UNETR.unetr_cube_1 import UNETR
...
parser.add_argument('--output', type=str, default='./uneout_cube1', required=False, help='Output folder for both tensorboard and the best model')
