...
def main():
    ...
    if not os.path.exists('/data1/gz/checkpoint/oasis/transmorph_cube/'+save_dir):
        os.makedirs('/data1/gz/checkpoint/oasis/transmorph_cube/'+save_dir)
    ...
    for epoch in range(epoch_start, 40):
        ...
        with torch.no_grad():
            ...
            if np.mean(val_loss) < best_dsc:
                ...
                }, save_dir='/data1/gz/checkpoint/oasis/transmorph_cube/' + save_dir,
                    filename='dsc{:.6f}.pth.tar'.format(loss_all.avg))
