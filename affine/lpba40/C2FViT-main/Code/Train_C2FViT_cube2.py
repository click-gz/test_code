...
from C2FViT_model_cube2 import C2F_ViT_stage, AffineCOMTransform, Center_of_mass_initial_pairwise, multi_resolution_NCC
...
def train():
    ...
    model_dir = "/data1/gz/checkpoint/affine/lpba40/c2fvit_cube2"
