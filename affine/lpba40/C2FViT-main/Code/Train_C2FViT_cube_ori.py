...
from C2FViT_model_cube_ori import C2F_ViT_stage, AffineCOMTransform, Center_of_mass_initial_pairwise, multi_resolution_NCC
...
def train():
    ...
    model_dir = "/data1/gz/checkpoint/affine/lpba40/c2fvit_cube_ori"
    ...
    while step <= iteration:
        ...
        with torch.no_grad():
            ...
            if np.mean(val_loss) < be:
                be = np.mean(val_loss)
                modelname = model_dir + '/' + model_name + "stagelvl3.pth"
