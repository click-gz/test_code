...
if __name__ == '__main__':
    ...
    best_ncc = 0
    with torch.no_grad():
        for checkpoint in glob.glob("/data1/gz/checkpoint/affine/lpba40/c2fvit/*.pth"):
            print(checkpoint)
        ...
        #     moving_img, init_flow = init_center(moving_img, fixed_img)
            ...
            for X, seg in test_loader:
                ...
                sitk.WriteImage(sitk.GetImageFromArray(x_seg_out.detach().cpu().numpy()[0, 0, ...]), "./seg_out.nii")
