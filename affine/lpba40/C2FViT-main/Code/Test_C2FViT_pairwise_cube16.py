...
from C2FViT_model_cube16 import C2F_ViT_stage, AffineCOMTransform, Center_of_mass_initial_pairwise
...
if __name__ == '__main__':
    ...
    best_ncc = 0
    with torch.no_grad():
        for checkpoint in glob.glob("/data1/gz/checkpoint/affine/lpba40/c2fvit_cube16/*.pth"):
            print(checkpoint)
