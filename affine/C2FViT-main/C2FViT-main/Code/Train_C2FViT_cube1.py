...
from C2FViT_model_cube1 import C2F_ViT_stage, AffineCOMTransform, Center_of_mass_initial_pairwise, multi_resolution_NCC
...
def train():
    ...
    model_dir = "/data1/gz/checkpoint/affine/oasis/c2fvit_cube"
    ...
    while step <= iteration:
        ...
        with torch.no_grad():
            ...
            if np.mean(val_loss) < be:
                be = np.mean(val_loss)
                modelname = "/data1/gz/checkpoint/affine/oasis/c2fvit_cube1/" + str(step) + '.pth'
