...
if __name__ == '__main__':
    ...
    best_ncc = 0
    with torch.no_grad():
        for checkpoint in glob.glob("/data1/gz/checkpoint/affine/oasis/c2fvit_cube/*.pth"):
            ...
            for X, Y, x_seg, y_seg in test_loader:
                ...
                sitk.WriteImage(sitk.GetImageFromArray(warpped_x_list[-1].detach().cpu().numpy()[0, 0, ...]), "./out.nii")
                break
