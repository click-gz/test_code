...
from data.ImageFolder import LungCtDataset
...
def train():
    ...
    model = C2F_ViT_stage(img_size=img_size, patch_size=[3, 7, 15], stride=[2, 4, 8], num_classes=12,
    ...
    model_dir = "/data1/gz/checkpoint/affine/lungct/c2fvit_cube"
    ...
    while step <= iteration:
        ...
        if step > iteration:
            break
        print("one epoch pass: ", be)
    np.save("train.npy", lossall)
